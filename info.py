...
ADMIN = int(environ.get('ADMIN', '6047654034'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002891364988'))
...
STREAM_URL = environ.get("STREAM_URL", "https://watchonlinespk99.blogspot.com/2025/07/spk.html")
